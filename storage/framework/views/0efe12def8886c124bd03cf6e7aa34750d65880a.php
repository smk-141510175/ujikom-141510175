        ...
        <nav class="navbar navbar-default navbar-static-top">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <?php echo e(config('', 'Jabatan')); ?>

                    </a>
                    </li>
                    <li>
                    <a href="<?php echo e(url('/Golongan')); ?>">
                        <?php echo e(config('', 'Golongan')); ?>
                    ...
                    <a  href="<?php echo e(url('/Kategori_Lembur')); ?>">
                        <?php echo e(config('', 'Kategori Lembur')); ?>
                    ...
                    <a  href="<?php echo e(url('/Lembur_Pegawai')); ?>">
                        <?php echo e(config('', 'Lembur Pegawai')); ?>
                    ...
                    <a  href="<?php echo e(url('/Tunjangan_Pegawai')); ?>">
                        <?php echo e(config('', 'Tunjangan Pegawai')); ?>
